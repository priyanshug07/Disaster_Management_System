            ...
            <div>
                <Navbar dark expand="md">
                    <div className="container">
                        ...
                        <NavbarBrand className="mr-auto" href="/"><img src='assets/images/logo.png' height="35" width="35" alt='V.I.B.E. Tech' /></NavbarBrand>
                    ...
                    <div className="container">
                        <div className="row row-header">
                            <div className="col-12 col-sm-6">
                                ...
                                <p>We help you communicate with others affected! (Remeber helping one another can only save us!)</p>
                            </div>
                        </div>
                    </div>
                </Jumbotron>
                ...
                <Modal isOpen={this.state.isSignUpOpen} toggle={this.toggleSignUp}>
                    <ModalHeader toggle={this.toggleSignUp}>DISASTER CONNECT Registration</ModalHeader>
                    <ModalBody>
